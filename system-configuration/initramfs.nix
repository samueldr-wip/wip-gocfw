...
in
{
  ...
  config = {
    wip.stage-1.contents = {
      ...
      extraUtils = runCommandNoCC "hello-wip-games-os--initramfs-extraUtils" {
        passthru = {
          inherit extraUtils;
        };
      } ''
      ...
      "/bin/sh" = runCommandNoCC "hello-wip-games-os--initramfs-extraUtils-bin-sh" {} ''
        mkdir -p $out/bin
